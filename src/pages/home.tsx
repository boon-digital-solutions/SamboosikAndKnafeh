      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          >
            ...
            >
              <Sparkles className="w-4 h-4 mr-2" />A Tale of Two Cats
            </Badge>
          </motion.div>
          ...
          >
            <span className="text-foreground" data-testid="text-samboosik">
              Samboosik
            </span>
            <span className="text-muted-foreground mx-4">&</span>
            <span className="text-foreground" data-testid="text-knafeh">
              Knafeh
            </span>
          </motion.h1>
          ...
          >
            <div
              className="flex items-center gap-2 bg-card/80 backdrop-blur-sm rounded-full px-4 py-2 border border-border"
              data-testid="badge-adoption-date"
            >
              <Calendar className="w-4 h-4 text-primary" />
              <span className="text-sm" data-testid="text-adoption-date">
                Adopted 2018 & 2021
              </span>
            </div>
            <div
              className="flex items-center gap-2 bg-card/80 backdrop-blur-sm rounded-full px-4 py-2 border border-border"
              data-testid="badge-forever-family"
            >
              <Heart className="w-4 h-4 text-primary" />
              <span className="text-sm" data-testid="text-forever-family">
                Forever Family
              </span>
            </div>
          </motion.div>
      ...
      <div className="w-full lg:w-1/2 space-y-4">
        ...
        >
          ...
          <div className="absolute bottom-6 left-6 right-6">
            <Badge
              className="mb-2 bg-primary/90 text-primary-foreground"
              data-testid={`badge-adopted-${name.toLowerCase()}`}
            >
              {adoptedYear}
            </Badge>
            <h3
              className="font-display text-3xl sm:text-4xl font-bold text-white drop-shadow-lg"
              data-testid={`heading-profile-${name.toLowerCase()}`}
            >
              {name}
            </h3>
          </div>
        ...
        >
          <img
            ...
            className={`w-full h-full object-cover ${secondImgClasses}`}
          />
        </motion.div>
      </div>
      ...
      <div className="w-full lg:w-1/2 space-y-6">
        <div>
          <p
            ...
            data-testid={`label-nickname-${name.toLowerCase()}`}
          >
            Also known as
          </p>
          <p
            className="text-xl text-muted-foreground"
            data-testid={`text-nickname-${name.toLowerCase()}`}
          >
            {nickname}
          </p>
        </div>
        ...
        <p
          ...
          data-testid={`text-description-${name.toLowerCase()}`}
        >
          {description}
        </p>
        ...
        <div className="grid gap-4">
          <Card
            ...
            data-testid={`card-likes-${name.toLowerCase()}`}
          >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p
                    ...
                    data-testid={`label-likes-${name.toLowerCase()}`}
                  >
                    Likes
                  </p>
                  <p
                    className="text-foreground"
                    data-testid={`text-likes-${name.toLowerCase()}`}
                  >
                    {likes}
                  </p>
                </div>
          ...
          <Card
            className="border-border/50"
            data-testid={`card-dislikes-${name.toLowerCase()}`}
          >
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p
                    className="font-medium text-sm text-muted-foreground"
                    data-testid={`label-dislikes-${name.toLowerCase()}`}
                  >
                    Dislikes
                  </p>
                  <p
                    className="text-foreground"
                    data-testid={`text-dislikes-${name.toLowerCase()}`}
                  >
                    {dislikes}
                  </p>
                </div>
          ...
          <Card
            className="border-border/50"
            data-testid={`card-favorite-${name.toLowerCase()}`}
          >
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p
                    className="font-medium text-sm text-muted-foreground"
                    data-testid={`label-favorite-${name.toLowerCase()}`}
                  >
                    Favorite Thing
                  </p>
                  <p
                    className="text-foreground"
                    data-testid={`text-favorite-${name.toLowerCase()}`}
                  >
                    {favorite}
                  </p>
                </div>
          ...
          <Card
            ...
            data-testid={`card-funfact-${name.toLowerCase()}`}
          >
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p
                    ...
                    data-testid={`label-funfact-${name.toLowerCase()}`}
                  >
                    Fun Fact
                  </p>
                  <p
                    className="text-foreground"
                    data-testid={`text-funfact-${name.toLowerCase()}`}
                  >
                    {funFact}
                  </p>
                </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2
            ...
            data-testid="heading-profiles"
          >
            Our Beloved Cats
          </h2>
          <p
            className="text-muted-foreground text-lg max-w-2xl mx-auto"
            data-testid="text-profiles-description"
          >
            Get to know Samboosik and Knafeh - each with their own unique
            personality, quirks, and way of winning hearts.
          </p>
        </motion.div>
...
function GallerySection() {
  const images = [
    {
      src: bothCuddling,
      alt: "Both cats cuddling by the window",
      caption: "Cuddling by the window (without Samboosik's consent)",
    },
    {
      src: bothCurled,
      alt: "Both cats curled up together",
      caption: "A rare peaceful moment together",
    },
    {
      src: samboosikTunnel,
    ...
    {
      src: knafehPetted,
      alt: "Knafeh being petted",
      caption: "Knafeh enjoying some love",
    },
    {
      src: knafehSink,
    ...
    {
      src: familyKitchen,
      alt: "All cats with jiddo",
      caption: "Treat time with jiddo",
    },
  ];
              ...
              <div className="relative aspect-square rounded-2xl overflow-hidden shadow-lg">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                  <p
                    ...
                    data-testid={`text-gallery-caption-${index}`}
                  >
                    {image.caption}
                  </p>
                </div>
  ...
  const stories = [
    {
      ...
      content:
        "When Knafeh was adopted, he thought Samboosik was his mom. He used to try to nurse. Samboosik never forgave him for that. Now, Knafeh can't even be in the vicinity without Samboosik hissing at him. Don't be fooled by pictures of them cuddling; it was always Knafeh cuddling without Samboosik's consent.",
      icon: Heart,
    },
    {
      title: "The Meow Mix Signal",
      content:
        "Both cats respond to the Meow Mix song. They were trained to associate the song with food, so whenever they're lost, the family plays the song and they come running. It's their secret cat signal!",
      icon: Star,
    },
    {
      title: "The Double Life",
      content:
        "Knafeh loves to go outside and explore the neighborhood. He is notorious for staying out way too late, making his teta worry all night. The family suspects he has another family somewhere in the neighborhood!",
      icon: Cat,
    },
  ];
    ...
    <section className="py-24 bg-gradient-to-b from-background to-primary/5">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Some of the most memorable stories from the lives of Samboosik and
            Knafeh.
          </p>
        </motion.div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {stories.map((story, index) => (
            ...
            >
              <Card
                className="h-full border-border/50 hover-elevate overflow-visible"
              ...
              >
                <CardContent className="p-6">
                  ...
                  <h3
                    ...
                    data-testid={`heading-story-${index}`}
                  >
                    {story.title}
                  </h3>
                  <p
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-display text-xl font-semibold mb-2">
                    Warning: Expert Hunters
                  </h3>
                  <p className="text-muted-foreground leading-relaxed">
                    Both cats are notorious hunters. They occasionally bring
                    "gifts" from the neighborhood to show their love. The family
                    has learned to check at the door before stepping outside!
                  </p>
                </div>
              </div>
            </CardContent>
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2
            className="font-display text-4xl sm:text-5xl font-bold mb-4"
            data-testid="heading-family"
          >
            Important Relationships
          </h2>
          <p
            className="text-muted-foreground text-lg max-w-2xl mx-auto"
            data-testid="text-family-description"
          >
            Samboosik and Knafeh are part of a loving family that includes
            special humans and fellow furry friends.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <Card
              ...
              data-testid="card-family-humans"
            >
              <div className="relative aspect-[4/3]">
                <img
                  src={familyKitchen}
                  alt="Cats with their jiddo"
                  className="w-full h-full object-cover"
                  data-testid="img-family-jiddo"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <div className="absolute bottom-4 left-4 right-4">
                  <h3
                    className="font-display text-2xl font-bold text-white mb-1"
                    data-testid="heading-humans-love"
                  >
                    The Humans They Love
                  </h3>
                  <p
                    className="text-white/80 text-sm"
                    data-testid="text-humans-names"
                  >
                    Their jiddo, teta, Khalto Hala, and Khalto Farah
                  </p>
                </div>
              </div>
              <CardContent className="p-6">
                <p
                  className="text-muted-foreground leading-relaxed"
                  data-testid="text-humans-description"
                >
                  Samboosik's favorite humans are his Khalto Hala and his jiddo.
                  Knafeh's best friends are his mom and his teta. They also love
                  their Khalto Farah, who is the mother of their cousin cats
                  Gaza, Beirut, and Zaina.
                </p>
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="border-border/50" data-testid="card-cousin-cats">
              <CardContent className="p-6">
                <h3
                  className="font-display text-xl font-semibold mb-3"
                  data-testid="heading-cousin-cats"
                >
                  Cousin Cats
                </h3>
                <p
                  className="text-muted-foreground leading-relaxed mb-4"
                  data-testid="text-cousin-cats"
                >
                  Samboosik and Knafeh live with their cousin cats - Beirut and
                  Gaza. They're all part of one big, furry family!
                </p>
                <div className="flex gap-2">
                  <Badge variant="secondary" data-testid="badge-beirut">
                    Beirut
                  </Badge>
                  <Badge variant="secondary" data-testid="badge-gaza">
                    Gaza
                  </Badge>
                </div>
              </CardContent>
              ...
              <div className="flex flex-col sm:flex-row">
                <div className="sm:w-2/5">
                  <img
                    ...
                    data-testid="img-zaina"
                  />
                </div>
                <CardContent className="p-6 sm:w-3/5">
                  <h3
                    className="font-display text-xl font-semibold mb-3"
                    data-testid="heading-zaina"
                  >
                    Cousin Zaina
                  </h3>
                  <p
                    className="text-muted-foreground leading-relaxed mb-3"
                    data-testid="text-zaina"
                  >
                    Zaina, their dog cousin, came to visit recently and the cats
                    are still trying to recover. Samboosik has started to spray
                    all around the house, marking his territory. His teta is
                    very upset about this.
                  </p>
                  <Badge
                    variant="outline"
                    className="text-destructive border-destructive/30"
                    data-testid="badge-knafeh-dislikes"
                  >
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          >
            Two beloved cats bringing joy, chaos, and endless love to their
            family since 2018 and 2021.
          </p>
          <div
